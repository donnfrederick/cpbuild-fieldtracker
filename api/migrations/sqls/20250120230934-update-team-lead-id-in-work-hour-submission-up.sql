...
BEGIN TRY
    -- 1. Update existing entries to set 'team_lead_id' to 1 where 'pay_type_id' has 'type_name' = 'Quantity'
    EXEC('
        UPDATE fhs
        SET team_lead_id = 1
        ...
        WHERE wpt.type_name = ''Quantity'' AND fhs.team_lead_id IS NULL;
    ');
