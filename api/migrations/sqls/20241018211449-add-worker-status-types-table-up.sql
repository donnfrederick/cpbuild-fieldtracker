...
BEGIN TRY
    -- Create field_tracker.worker_status_types table
    CREATE TABLE field_tracker.worker_status_types (
    ...
    INSERT INTO field_tracker.worker_status_types (status_name, description)
    VALUES 
